...
function CameraController() {
    ...
    useFrame(() => {
        ...
        if (prefersReducedMotion) {
            // If the user prefers reduced motion, keep the camera at the base position
            camera.position.set(
        ...
        const tiltX = (mouse.y - 0.5) * 3; // Adjust the multiplier to control the tilt intensity
        ...
        currentPositionRef.current.lerp(targetPosition, 0.1); // Smoothly interpolate to the target position
...
export function Scene() {
    ...
    // to make the scene responsive on smaller screens
