    ...
    >
      ...
      <div className="hero-content absolute inset-x-0 top-0 h-dvh">
        ...
        >
          ...
          <button className="font-black-slanted group flex w-fit cursor-pointer items-center gap-1 rounded bg-[#01A7E1] px-3 py-1 text-2xl uppercase transition disabled:grayscale">
